...
const MONTHLY_HOME_DATA: Record<string, HomeMockData> = {
  "2026-01": {
    ...
    platformDonut: {
      total: 684000,
      items: [
        { label: "쿠팡", value: 276000, percent: 40, color: tokens.color.warn },
        { label: "네이버쇼핑", value: 221000, percent: 32, color: tokens.color.cat2 },
        { label: "무신사", value: 187000, percent: 28, color: tokens.color.cat1 },
      ],
    },
    trend: {
      points: [
  ...
  "2026-02": {
    ...
    platformDonut: {
      total: 742000,
      items: [
        { label: "쿠팡", value: 288000, percent: 39, color: tokens.color.warn },
        { label: "네이버쇼핑", value: 262000, percent: 35, color: tokens.color.cat2 },
        { label: "무신사", value: 192000, percent: 26, color: tokens.color.cat1 },
      ],
    },
    trend: {
      points: [
  ...
  "2026-03": {
    ...
    platformDonut: {
      total: 823000,
      items: [
        { label: "쿠팡", value: 311000, percent: 38, color: tokens.color.warn },
        { label: "네이버쇼핑", value: 276000, percent: 34, color: tokens.color.cat2 },
        { label: "무신사", value: 236000, percent: 28, color: tokens.color.cat1 },
      ],
    },
    trend: {
      points: [
  ...
  "2026-04": {
    ...
    platformDonut: {
      total: 918000,
      items: [
        { label: "쿠팡", value: 356000, percent: 39, color: tokens.color.warn },
        { label: "네이버쇼핑", value: 321000, percent: 35, color: tokens.color.cat2 },
        { label: "무신사", value: 241000, percent: 26, color: tokens.color.cat1 },
      ],
    },
    trend: {
      points: [
